  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        'The card turns to face whoever is deciding — a half turn for the chair opposite, a quarter for the ones at the sides — so nobody reads the numbers upside down or sideways.',
